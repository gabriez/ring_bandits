...
let sliderTest = document.getElementById('slider-information');
...
for (let i = 0; i < slides.length; i++) {
   ...
   if (i > 0) {
    sliderContainerFreeSpace += ((sliderContainerWidth - totalSlidesWidth) / slides.length )+ slides[i].clientWidth;
